...
from autoencoder_conf import prepare_autoencoder1
encoder, loss_encoder, decoder, loss_decoder = prepare_autoencoder1(num_hidden, num_outputs, model_ctx)
elapsed_time = time.time() - start_time
...
start_time = time.time()
save_data("./results/predictions/lab4_conf1_pred_stack.npy", all_data, train_data, encoder, model_ctx)
elapsed_time = time.time() - start_time
